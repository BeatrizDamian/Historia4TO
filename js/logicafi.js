var app = new Vue({
		...
		data:{
			...
			pista:["casa"],
			frase:['mexicas',"comercio","reinos","costas","puertos"]
			...
			comparar: function(caracter,posicion){
				...
				if(this.contador_aciertos==this.palabra_generada.length){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anime/boyone/ganador.png" alt="Ganaste">`,
				...
				if(this.contador_errores==5){
					...
					Swal.fire({
										...
										html: `<img class="img-fluid" src="../anime/boyone/perdedor.png" alt="Ganaste">`,
										confirmButtonText: "Volver a Jugar",
										confirmButtonColor:'#00CC33',
										allowOutsideClick: false,
										allowEscapeKey: false,
